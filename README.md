...
|____/ \__, |\___|____/ \__, |\___| \_/  |_|   |_| \_|
       |___/            |___/
   Full TSPU/DPI/VPN detectability scanner   v2.2
```
...
Download `byebyevpn-v2.2-win64.zip` from [Releases](../../releases),
...
The v2.2 source is Windows-only (uses `winsock2`, `iphlpapi`, `winhttp`,
...
```bash
wget https://github.com/pwnnex/byebyevpn/releases/latest/download/byebyevpn-v2.2-win64.zip
unzip byebyevpn-v2.2-win64.zip
...
Just grab `byebyevpn-v2.2-win64.zip` from [Releases](../../releases) — it's
...
Исходник v2.2 пока только под Windows (использует `winsock2`, `iphlpapi`,
...
Скачиваешь `byebyevpn-v2.2-win64.zip` из [Releases](../../releases) —
