...
|____/ \__, |\___|____/ \__, |\___| \_/  |_|   |_| \_|
       |___/            |___/
   Full TSPU/DPI/VPN detectability scanner   v2.3
```
...
Download `byebyevpn-v2.3-win64.zip` from [Releases](../../releases),
...
Just grab `byebyevpn-v2.3-win64.zip` from [Releases](../../releases) — it's
...
Скачиваешь `byebyevpn-v2.3-win64.zip` из [Releases](../../releases) —
